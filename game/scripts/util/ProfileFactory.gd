...
static func new_profile(name: String, race_id: String, gender: String, class_id: String) -> Dictionary:
	...
	return {
		"character": {
			...
			"body_type": 0, "hair_type": int(race.get("default_hair_type", 1)), "hair_color": race.get("default_hair_color", "#222629"),
			"eye_type": 0, "eye_color": race.get("default_eye_color", "#222629"), "skin_color": race.get("default_body_color", "#FFD3C9"),
			"skin_color2": race.get("default_body_color2", "#572117"), "skin_color3": race.get("default_body_color3", "#FFD3C9"),
			"nose": 0, "mouth": 0, "tattoo": 0, "aura_color": race.get("default_aura_color", "#7FFFFF"),
		},
